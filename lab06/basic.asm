...
lightup0:
    ...
    Check0:
    BTFSC PORTB, 0      ; Check if PORTB bit 0 is low (button pressed)
    BRA Check0   ; If button is not pressed, branch back to self
...
lightup1:
    ...
    Check1:
    BTFSC PORTB, 0      ; Check if PORTB bit 0 is low (button pressed)
    BRA Check1   ; If button is not pressed, branch back to self
...
lightup2:
    ...
    Check2:
    BTFSC PORTB, 0      ; Check if PORTB bit 0 is low (button pressed)
    BRA Check2   ; If button is not pressed, branch back to self
    BRA Off         ; If button is pressed, branch to Off 
